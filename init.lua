...
-- Better diagnostic
vim.keymap.set('n', '<leader>wd', '<C-w><C-d>', { desc = 'Open Diagonstic Floating Window' })
...
require('lazy').setup({
  ...
  'NMAC427/guess-indent.nvim', -- Detect tabstop and shiftwidth asutomatically
